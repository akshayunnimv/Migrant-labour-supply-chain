...
<div class="matches elite-app">
	...
	<div class="matches-main-agileinfo">
		<div class="col-md-6 profile1"> 
                    <img style="width: 245px;height: 300px" src="../img7/<?php echo $r_gal[7] ?>">
		</div>
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
				<li><span>Name</span>: <?php echo $r_gal[1] ?></li>
				<li><span>SI</span>: <?php echo $r_gal[2] ?></li>
				
				
				
				<li><span>Email</span>: <?php echo $r_gal[4] ?></li>
				<li><span>Contact</span>: <?php echo $r_gal[5] ?></li>
                               
                                <br/>
<!--                                <li><a href="../img5/<?php echo $r_gal[10] ?>">Download Info <div class="fa fa-download"></div></a></li>
			-->
		...
		<div class="about-person">
			...
			<p class="para-agileits-w3layouts"><span>Hi!, we are <?php echo $r_gal[1] ?> </span>Address:<?php echo substr($r_gal[3],0,200)?>.....</p>
                        <div class="sim-button button12"><a href="police_dt.php?mid=<?php echo $r_gal[5] ?>">Read More</a></div>
		</div>
	</div>
	<?php
                                                            }
