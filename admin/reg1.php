...
if(mysqli_num_rows($log1)>0)
{
 header("location:reg1.php?fail=1");   
    ...
    $ins=mysqli_query($dbcon,"insert into police values('','$t1','$t2','$t3','$t4','$t5','$t6','$nfn','$la','$lo','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t5','$t6','police','1')");
        if($ins1>0)
        {
	...
	<div class="col-md-8 login-form-w3-agile">
			<form  method="post" enctype="multipart/form-data">
				...
				<div class="w3_form_body_grid w3_form_body_grid1">
					<span>Name</span>
					<input type="text" name="t1" placeholder="Station Name" required="">
				</div>
				
				<div class="w3_form_body_grid w3_form_body_grid1">
					<span>SI</span>
					<input type="text" name="t2" placeholder="SI Name" required="">
				</div>
					...
					<span>Longitude</span>
                               ...
                               <div class="w3_form_body_grid">
					<span>Contact</span>
                                        <input type="text" name="t4" placeholder="Contact Info" required=""onkeyup="chkc(this.value)"><b id="o3"></b>
				</div>
				<div class="w3_form_body_grid">
					<span>Email</span>
                                        <input type="email" name="t5" placeholder="Email" required=""onkeyup="vem(this.value)"><b id="em"></b>
				</div>
				<div class="w3_form_body_grid w3_form_body_grid1">
					<span>Password</span>
