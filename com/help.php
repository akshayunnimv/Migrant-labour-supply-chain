...
<div class="matches elite-app">
	...
	<div class="tittle-agileinfo">
		<h3>Approved Service</h3>
         ...
         <?php
                                                        ...
                                                        $sel1=mysqli_query($dbcon,"select * from req where st='1' and cid='$usr'  order by id desc");
    ...
    $r2=  mysqli_num_rows($sel2);
		...
		<div class="about-person">
                    <div class="sim-button button12"><a href="staff1.php?mid=<?php echo $r1[0] ?>">Assign Workers</a></div>&nbsp;&nbsp;
		</div>
	</div>
	<?php
                                                            }
