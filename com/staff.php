		...
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
				...
				<li><span>Contact</span>: <?php echo $r_gal[5] ?></li>
                                  <br/>
                                  <li><a target="_blank"href="../img6/<?php echo $r_gal[9] ?>">Download Info <div class="fa fa-download"></div></a>   <a target="_blank" href="print.php?mid=<?php echo $r_gal[0] ?>">Print card <div class="fa fa-print"></div></a></li>
                                </ul>
		</div>
