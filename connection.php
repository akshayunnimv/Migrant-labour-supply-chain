...
$dbcon=mysqli_connect("localhost","root","","labour");
$date=date('Y-m-d');
...
{
document.getElementById("np3").innerHTML="<font color='red'>*Only Numbers*</font>";
$("#btn").hide();
return false;
}
else if(k5!=12)
{
document.getElementById("np3").innerHTML="<font color='red'>*Please Check Your Aadhar number*</font>";
$("#btn").hide();
return false;
}
else
