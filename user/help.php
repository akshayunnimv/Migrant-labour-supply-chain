...
<div class="matches elite-app">
	...
	<div class="tittle-agileinfo">
		<h3>Approved Service</h3>
         ...
         <?php
                                                        ...
                                                        $sel1=mysqli_query($dbcon,"select * from req where st='1' and uid='$usr' order by id desc");
                                                        while($r1=mysqli_fetch_row($sel1))
                                                        {
                                                                $sel_gal=mysqli_query($dbcon,"select * from com_data where em='$r1[8]'");
    ...
    $r2=  mysqli_num_rows($sel2);
		...
		<div class="about-person">
                    <div class="sim-button button12"><a href="com_dt.php?mid=<?php echo $r_gal[6] ?>">Company Details</a></div>&nbsp;&nbsp;<div class="sim-button button12"><a href="staff1.php?mid=<?php echo $r1[0] ?>">Assigned Workers</a></div>
		</div>
	</div>
	<?php
                                                            }
