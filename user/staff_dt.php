...
$sel=mysqli_query($dbcon,"select * from staff_data where em='$mid'");
...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into staff_rev values('','$usr','$mid','$t1','$date','0')");
    
    if($ins>0)
    {
      
                header("location:staff_dt.php?mid=$mid");
            }
    }
...
<div class="matches elite-app">
	...
	<div class="matches-main-agileinfo">
		<div class="col-md-6 profile1"> 
                    <img style="width: 245px;height: 300px" src="../img5/<?php echo $r[8] ?>">
		</div>
		<div class="col-md-6 person-info-agileits-w3layouts">
			<ul>
				...
				<li><span>Age</span>: <?php echo $r[3] ?></li>
                                <li><span>Experience</span>: <?php echo $r[4] ?></li>
				
				
				<li><span>Email</span>: <?php echo $r[6] ?></li>
				<li><span>Contact</span>: <?php echo $r[5] ?></li>
                                <br/>
                                <li><a href="../img6/<?php echo $r[9] ?>">Download Info <div class="fa fa-download"></div></a></li>
                                </ul>
		</div>
		...
		<div id="horizontalTab">
						...
						<div class="tab1">
                                                 ...
                                                 <?php
                        $a1=mysqli_query($dbcon,"select * from assi where sid='$mid'");
                                                         while($a2=mysqli_fetch_row($a1))
            {
                                                        $sel1=mysqli_query($dbcon,"select * from req where id='$a2[1]'  order by id desc");
...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      <h2 class="page-header">Complaints</h2>
...
<div class="container">
    ...
    <div class="col-md-8">
    						<div class="widget-area no-padding blank">
								<div class="status-upload">
										...
										<br/>
										<button name="sub1" type="submit" class="btn btn-success green"><i class="fa fa-share"></i> Post Complaint</button>
									</form>
								</div><!-- Status Upload  -->
							</div><!-- Widget Area -->
						</div>
 ...
 <br/>
          <?php
            ...
            $sel_p=mysqli_query($dbcon,"select * from staff_rev where cid='$mid' order by id desc");
