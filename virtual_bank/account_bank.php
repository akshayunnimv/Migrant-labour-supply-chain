...
<?php
                            ...
                            {
                                $b=mysqli_query($dbcon,"select max(id) from account_bank");
$id=mysql_result($b,0);
$id++;
$p=$_FILES['p1']['name'];
$ext=strchr($p,'.');
...
{
   $a=mysqli_query($dbcon,"select max(id) from account_bank");
$id=mysql_result($a,0);
$id++;
$f=$_FILES['f1']['name'];
$ext=strchr($f,'.');
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-6"><h2 style="color: #00ACED;font: italic">Create Account</h2>
                    ...
                    <table  class="table  table-responsive  table-striped table-bordered ">
                        ...
                        <tr>
                            <td>Contact</td>
                            <td><input type="text"name="t3"id="t3"class="form-control"required="required"onblur="chkc(this.value)"/><span id="o3"></span></td>
                        </tr>
                        <tr>
                            <td>Email</td>
                         ...
                         <tr>
                             ...
                             <td colspan="2" align="center">
                                 <font color="green"> <?php
                                                        ...
                                                        ?></font>
                                 <input type="submit"value="Create Account" id="btn" name="b1"class="btn btn-success"></td>
                        </tr>
                    </table>
        ...
        <tr>
         ...
         <tr>
             ...
             <td><b>Id Proof:</b>    <a href="img2//<?php echo $r_m1['6']?>"target="_blank"><span class="glyphicon glyphicon-fullscreen"style="color: #D00030"></span></a></td>
                                        ...
                                        $sel_mem=mysqli_query($dbcon,"select * from account_bank order by id desc");
