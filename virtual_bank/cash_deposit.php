    ...
    <table class="table table-responsive"style="background: #E5E5E5">
        <?php
                            ...
                            if(isset($_POST['b1']))
                            {
                                ...
                                $qry=mysqli_query($dbcon,"select * from account_bank where account_no='$_POST[t1]'");
                                
                               $amt=mysqli_fetch_row($qry);
...
?>
        <tr>
            <td>Account No</td>
            <td><input type="text" required=""name="t1"class="form-control"></td>
        </tr>
        <tr>
            <td>Amount</td>
            <td><input type="text" required=""name="t2"class="form-control"placeholder="Rs/-"></td>
        </tr>
        <tr>
            <td></td>
